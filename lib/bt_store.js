...
export function get_bts() {
	if (_cached_bts) return _cached_bts;
	_cached_bts = game.settings.get(MODULE_ID, "behaviour_trees") || {};
	return _cached_bts;
}

export function invalidate_bts_cache() {
	_cached_bts = null;
}
