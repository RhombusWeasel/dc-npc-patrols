...
import { register as register_time } from "./condition/time.js";
import { register as register_combat } from "./condition/combat.js";
import { register as register_my_turn } from "./condition/my_turn.js";
import { register as register_can_move } from "./condition/can_move.js";
import { register as register_weather } from "./condition/weather.js";
import { register as register_day } from "./condition/day.js";
...
// ── Action ──────────────────────────────────────────────────────
import { register as register_patrol } from "./action/patrol.js";
...
import { register as register_flee } from "./action/flee.js";
import { register as register_sleep } from "./action/sleep.js";
import { register as register_wake } from "./action/wake.js";
import { register as register_set_token_image } from "./action/set_token_image.js";
import { register as register_emote } from "./action/emote.js";
import { register as register_face_player } from "./action/face_player.js";
import { register as register_face_target } from "./action/face_target.js";
import { register as register_close_on_target } from "./action/close_on_target.js";
import { register as register_idle } from "./action/idle.js";
...
import { register as register_measure_range } from "./action/measure_range.js";
...
export function init_bt_nodes() {
	...
	register_emote();
	register_face_player();
	register_face_target();
