...
export class DialogEditor extends HandlebarsApplicationMixin(ApplicationV2) {
	...
	async _inject_boon_editors(html) {
		const { get_boon_templates } = await import("systems/Deadlands-Classic/module/sheets/boon_templates.js");
		const { BoonEditor } = await import("systems/Deadlands-Classic/module/sheets/editor.js");
