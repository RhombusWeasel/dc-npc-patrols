...
import { request_quest_write, get_cached_quests } from "../quest_socket.js";
...
export default async function modify_quest(boon, context) {
	...
	const quests = game.user.isGM ? game.dc.posse.get_quests(posse.id) : get_cached_quests(posse.id);
