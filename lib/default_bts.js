...
export function get_default_bts() {
	return {
		...
		bt_fighter: {
			id: "bt_fighter",
			name: "Fighter",
			description: "On combat turn, acquires a visible hostile player and fires when in range.",
			variables: [
				{ key: "attack_range", label: "Attack Range (grid squares)", type: "number", default: 6 },
			],
			root: {
				_id: _nid(),
				type: "selector",
				...
				children: [
					{
						...
						children: [
							...
							{
								_id: _nid(),
								type: "action_measure_range",
								_label: "",
								target_key: "target",
								measure_mode: "combat_grid",
							},
							{
								_id: _nid(),
