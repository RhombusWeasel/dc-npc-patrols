 ...
 *   - Townsperson: wanders by day, sleeps at night, flees in combat
 *   - Guard: idles and watches, reacts to combat by fleeing to alarm, faces players
...
export function get_default_bts() {
	return {
		bt_townsperson: {
			id: "bt_townsperson",
			name: "Townsperson",
			description: "Wanders by day, sleeps at night, flees in combat, reacts to town alarm.",
			variables: [
		...
		bt_guard: {
			id: "bt_guard",
			name: "Guard",
			description: "Idles and watches, faces players, flees to alarm in combat.",
			variables: [
