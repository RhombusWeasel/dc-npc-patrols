...
function _reconstruct_path(came_from, end_key, grid_data) {
	...
	//
	// Diagonal A* paths (e.g. NE at nav-cell level) produce diagonal grid
	// tiles once boundary-crossing steps are extracted, so the token moves
	// in clean diagonals instead of staircases.
	//
