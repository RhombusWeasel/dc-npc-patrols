...
import { get_cached_quests, request_quest_state, request_quest_write } from "./quest_socket.js";
...
export async function prepare_quests_tab_context(actor) {
	...
	const quests_map = game.user.isGM ? game.dc.posse.get_quests(posse.id) : get_cached_quests(posse.id);
