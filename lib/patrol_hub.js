...
import { QuestEditorController } from "./quest_editor.js";
...
export class PatrolHub extends HandlebarsApplicationMixin(ApplicationV2) {
	...
	_quest_ctrl = new QuestEditorController();
	...
	async _prepareContext(_options) {
		...
		} else if (this._active_view === "world_quests") {
			Object.assign(ctx, await this._quest_ctrl.prepare_context());
		}
	...
	async _onRender(context, options) {
		...
		if (this._active_view === "scene") {
			...
			this._quest_ctrl.wire_events(html, host);
